...
EC_LOOKUP_TABLE:
	...
	EC_LOOKUP_ITEM Z80_68K_COMM_ERROR_DATA
	EC_LOOKUP_ITEM Z80_68K_COMM_ERROR_CLEAR
...
STR_Z80_68K_COMM_ERROR_DATA:	STRING "Z80<->68k COMM. ERROR (DATA)"
STR_Z80_68K_COMM_ERROR_CLEAR:	STRING "Z80<->68K COMM. ERROR (CLEAR)"
