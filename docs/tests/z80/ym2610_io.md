...
Note this is a legacy error code and should only show up if you are using an
older diag m1.  The tests have since been broken up into individual error codes.
